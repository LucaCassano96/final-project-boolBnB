        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="card rounded" style="background-color: #5c80bc">
                    ...
                    @if (session('success'))
                        <div id="paymentConfirm" class="alert alert-success alert-dismissible fade show" role="alert"
                                        ...
                                        <div class="row justify-content-center align-items-center p-2">
                                            ...
                                            <div class="col-md-4">
                                                <div class="d-flex justify-content-around align-items-center">
                                                    ...
                                                    {{-- Aggiungi --}}
                                                    <a class="add-apartment d-flex justify-content-center align-items-center text-decoration-none"
                                    ...
                                    @foreach ($user->apartments as $apartment)
                                        ...
                                        <div class="col-6 col-lg-4 col-xl-2 p-3 d-flex align-items-end">
                                            <div class="card border text-center p-0"
                                                style="min-height:430px; background-color:#2d3047; border-color:#fffdeb">

                                                {{-- Card Body --}}
                                                <div class="card-body p-2">
                                                    {{-- immagine --}}
                                                    <div class="rounded mb-2"
                                                        style="width:100%; aspect-ratio: 1 / 1; border: 2px solid #e0a458;">
                                                    ...
                                                    <div class="my-2" style="color: #fffdeb">
                                                        ...
                                                        {{-- indirizzo --}}
                                                        <div class="d-flex justify-content-center align-items-center p-1 my-2"
                                                            style="height:60px; overflow:hidden;">
                                                            <span
                                                                style="text-overflow:'(...)';">{{ $apartment->address }}</span>
                                                        </div>
                                                    ...
                                                    @if ($apartment->sponsor->isNotEmpty())
                                                        @foreach ($apartment->sponsor as $sponsor)
                                                            @if ($sponsor->pivot->end_date > now())
                                                                <div
                                                                    class="text-primary-emphasis bg-primary-subtle border border-primary-subtle rounded-3 py-1">
                                                                    Sponsorizzato
                                                                </div>
                                                            @else
                                                                <a href="{{ route('sponsor-form', $apartment->id) }}"
                                                                    class="py-1 btn btn-secondary">Sponsorizza</a>
                                                            @endif
                                                        @endforeach
                                                    @else
                                                        <a href="{{ route('sponsor-form', $apartment->id) }}"
