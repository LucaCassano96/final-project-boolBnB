...
<div class="container" style="background-color: #2d3047">
            ...
            @foreach ($apartments as $apartment)
                @if ($apartment->visible && $apartment->sponsor)
                    <div class="col-md-6 col-lg-4 col-xl-3 p-2">
                        <div class="border p-1 border-warning rounded-2 justify-content-center" style="background-color: #e0a458">
                            {{-- logo sponsor --}}
                            <div class="align-items-center mt-0">
                                <h1 class="p-0 m-0 text-end"><i class="bi bi-badge-ad"></i></h1>
                            </div>
                            {{-- card --}}
    ...
    <!--Tutti gli appartamenti (non in evidenza)-->
    <div class="row mt-4">
        @foreach ($apartments as $apartment)
            @if ($apartment->visible && !$apartment->sponsor)
