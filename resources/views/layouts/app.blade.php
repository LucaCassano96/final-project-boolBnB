...
<body>
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color: #2d3047;">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" style="color: #fffdeb" href="{{ url('/') }}">
                    <div class="logo_laravel">
                        <h1><i class="fa-solid fa-person-shelter"></i>BoolBnB</h1>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link" style="color:#fffdeb" href="{{url('/') }}">{{ __('Home') }}</a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                        <li class="nav-item">
                            <a class="nav-link" style="color:#fffdeb" href="{{ route('login') }}">{{ __('Login') }}</a>
                        </li>
                        @if (Route::has('register'))
                        <li class="nav-item">
                            <a class="nav-link" style="color:#fffdeb" href="{{ route('register') }}">{{ __('Register') }}</a>
                        </li>
                        @endif
                        @else
